...
const Skill = () => {
  ...
  return (
    <div className="skill_container w-full overflow-hidden my-12 py-12">
      <div className="skill_slide grid grid-flow-col">
        {skills.map((skill) => {
          const { language, experience, icon } = skill;
          return (
            <div
              className="skill flex flex-col items-center justify-center gap-4 sm:gap-6 text-center w-52 px-4"
